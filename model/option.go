...
func InitOptionMap() {
	...
	common.OptionMap["CrossChannelRetryTimes"] = strconv.Itoa(common.CrossChannelRetryTimes)
	common.OptionMap["RetryTimeBudgetSeconds"] = strconv.Itoa(common.RetryTimeBudgetSeconds)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "CrossChannelRetryTimes":
		common.CrossChannelRetryTimes, _ = strconv.Atoi(value)
	case "RetryTimeBudgetSeconds":
		common.RetryTimeBudgetSeconds, _ = strconv.Atoi(value)
